...
export const MSG = {
  noActivity: t("过去 7 天无活动。", "No activity in the last 7 days."),
...
export const CLI_REPORT = {
  title: t("AI CLI 工具社区动态周报", "AI CLI Tools Community Digest"),
...
export const OPENCLAW_REPORT = {
  title: t("OpenClaw 生态周报", "OpenClaw Ecosystem Digest"),
...
export const INFRA_REPORT = {
  title: t("AI 基础设施周报", "AI Infrastructure Digest"),
  meta: (utcStr: string, count: number, lang: Lang) =>
    lang === "en"
...
export const WEB_REPORT = {
  ...
  todayUpdate: t("本周更新", "Weekly update"),
...
export const TRENDING_REPORT = {
  title: t("AI 开源趋势周报", "AI Open Source Trends"),
  ...
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `📈 AI Open Source Trends ${dateStr}` : `📈 AI 开源趋势周报 ${dateStr}`,
} as const;

export const HN_REPORT = {
  title: t("Hacker News AI 社区动态周报", "Hacker News AI Community Digest"),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `📰 Hacker News AI Digest ${dateStr}` : `📰 Hacker News AI 社区动态周报 ${dateStr}`,
} as const;

export const PH_REPORT = {
  title: t("Product Hunt AI 产品周报", "Product Hunt AI Products Digest"),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `🚀 Product Hunt AI Digest ${dateStr}` : `🚀 Product Hunt AI 产品周报 ${dateStr}`,
} as const;

export const ARXIV_REPORT = {
  title: t("ArXiv AI 研究周报", "ArXiv AI Research Digest"),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `📚 ArXiv AI Research Digest ${dateStr}` : `📚 ArXiv AI 研究周报 ${dateStr}`,
} as const;
...
export const COMMUNITY_REPORT = {
  title: t("技术社区 AI 动态周报", "Tech Community AI Digest"),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `💬 Tech Community AI Digest ${dateStr}` : `💬 技术社区 AI 动态周报 ${dateStr}`,
} as const;
...
export const CLI_ISSUE_TITLE = (dateStr: string, lang: Lang) =>
  lang === "en" ? `📊 AI CLI Tools Digest ${dateStr}` : `📊 AI CLI 工具社区动态周报 ${dateStr}`;

export const OPENCLAW_ISSUE_TITLE = (dateStr: string, lang: Lang) =>
  lang === "en" ? `🦞 OpenClaw Ecosystem Digest ${dateStr}` : `🦞 OpenClaw 生态周报 ${dateStr}`;

export const INFRA_ISSUE_TITLE = (dateStr: string, lang: Lang) =>
  lang === "en" ? `⚙️ AI Infrastructure Digest ${dateStr}` : `⚙️ AI 基础设施周报 ${dateStr}`;
...
export const FOOTER = {
  autoGen: t("本周报由", "This digest is auto-generated by"),
} as const;
